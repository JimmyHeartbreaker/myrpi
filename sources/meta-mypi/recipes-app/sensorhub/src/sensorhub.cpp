...
static int interval = 1;//INTERVAL;
...
{
    IOTHUB_MESSAGE_HANDLE messageHandle = IoTHubMessage_CreateFromByteArray((unsigned char *)buffer, strlen(buffer));
